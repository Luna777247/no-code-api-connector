...
export function ParametersStep({ data, onChange }: ParametersStepProps) {
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value: any) => setEditingParam({ ...editingParam, type: value })}
                >
            ...
            <div>
              ...
              <Tabs
                ...
                onValueChange={(value: any) => setEditingParam({ ...editingParam, mode: value })}
                className="mt-1.5"
              >
