  ...
  return (
    ...
    >
      ...
      <div suppressHydrationWarning={true}>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3" suppressHydrationWarning={true}>
          <div suppressHydrationWarning={true}>
        ...
        {/* Features Section */}
        <div className="mt-12 p-6 bg-muted/30 rounded-lg border" suppressHydrationWarning={true}>
