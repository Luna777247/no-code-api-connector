...
export default function RunDetailPage({ params }) {
  ...
  const requests = [
    { id: 1, url: "https://jsonplaceholder.typicode.com/users?id=1", status: 200, responseTime: 245, recordsExtracted: 10, timestamp: new Date(Date.now() - 3540000) },
    { id: 2, url: "https://jsonplaceholder.typicode.com/users?id=2", status: 200, responseTime: 198, recordsExtracted: 10, timestamp: new Date(Date.now() - 3420000) },
    { id: 3, url: "https://jsonplaceholder.typicode.com/users?id=3", status: 200, responseTime: 212, recordsExtracted: 10, timestamp: new Date(Date.now() - 3300000) },
  ]
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <ScrollArea className="h-80 border rounded-lg">
                    <pre className="p-4 text-xs font-mono">{JSON.stringify([
                      { user_id: 1, user_name: "John Doe", user_email: "john@example.com", user_phone: "+1-234-567-8900", company_name: "Acme Corp" },
                      { user_id: 2, user_name: "Jane Smith", user_email: "jane@example.com", user_phone: "+1-234-567-8901", company_name: "Tech Inc" },
                    ], null, 2)}</pre>
                  </ScrollArea>
                </div>
              </CardContent>
