...
export default function RunsPage() {
  ...
  return (
    <PageLayout title="Run History" description="View and monitor API execution history" showBackButton={true}>
      {/* Filters */}
      <Card className="mb-6">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {runs.map((run) => {
            const duration = run.executionTime ? `${Math.floor(run.executionTime / 1000)}s` : "In progress..."
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <CardTitle className="text-lg">Connection: {run.connectionId}</CardTitle>
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-5">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium mt-1">
                        {run.totalRequests > 0 ? Math.round((run.successfulRequests / run.totalRequests) * 100) : 0}%
                      </p>
                    </div>
                    <div>
